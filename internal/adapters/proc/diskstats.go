...
func (r ProcDiskStatsReader) ReadDiskStats() ([]domain.DiskStat, error) {
...
func parseDiskStats(r io.Reader) ([]domain.DiskStat, error) {
	var stats []domain.DiskStat
	...
	for scanner.Scan() {
		...
		stats = append(stats, domain.DiskStat{
			Device:      device,
			ReadsTotal:  reads,
			WritesTotal: writes,
