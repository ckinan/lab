...
func (r *ProcProcessReader) ReadProcesses() ([]Process, error) {
	...
	results := make([]Process, 0, len(entries))
...
func (r *ProcProcessReader) readOne(pid int, now time.Time) (Process, error) {
